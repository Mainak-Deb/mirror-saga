...
class straightline:
    def __init__(self,screen,point1,point2,typeof="none",color=(255,0,0)) -> None:
        self.point1=point1
        self.point2=point2
        self.screen=screen;
        self.color=color;
...
class angleline(straightline):
    def __init__(self, screen, point,angle, color=(255, 0, 0),typeof="light",length=4000) -> None:
        self.angle=angle
        self.point=point
        self.length=length
        self.screen=Screen
        ...
        self.typeof=typeof
        super().__init__(screen, point, (ex,ey),typeof, color)
    ...
    def updateAngle(self,state):
        ...
        ex=int(sx+(length*math.cos(angle*math.pi/180)))
        ey=int(sy-(length*math.sin(angle*math.pi/180)))
        super().__init__(self.screen, (int(sx),int(sy)), (int(ex),int(ey)),self.typeof, self.color)
