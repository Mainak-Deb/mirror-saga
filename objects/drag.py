...
# from straightline import angleline,straightline 
...
class Drag:
    def __init__(self,screen,center,size) -> None:
        ...
        self.calculate_pos()
        self.setState()
        self.bg=pygame.image.load('./assets/images/mirror.png')
        self.bg=pygame.transform.scale(self.bg,(self.arm,self.arm))
        self.rightClick=False
        self.dorotate=False
        self.rotate=90;
        self.prevang=90
        self.frc=mixer.Sound("./assets/sounds/friction.mp3")
        self.rrc=mixer.Sound("./assets/sounds/rotate.mp3")
    ...
    def line(self):
        ...
        return straightline(self.screen,(sx,sy),(ex,ey),"mirror")
